  ...
  return (
    <div className="w-full bg-[#131110] text-white flex lg:flex-row flex-col-reverse justify-between items-center px-[20px] py-[20px] xl:px-[15vw] xl:py-[3rem] ">
      <div className="left flex flex-col gap-[50px]">
        <h1 className="text-[3.8rem] leading-[4rem] mt-[30px] lg:mt-0 font-poppins font-semibold">
          Discover
          <br />
          Most Suitable
          <br />
        ...
        <div className="search_bar w-full md:flex md:flex-wrap md:items-center md:justify-between px-[20px] py-[10px] bg-white rounded-lg">
          ...
          />
          <button className="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-2 rounded-[4px] mt-2 md:mt-0 md:ml-2">
            Search
          </button>
        </div>
